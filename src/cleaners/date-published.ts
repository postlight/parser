import moment, { MomentFormatSpecification, unitOfTime } from 'moment-timezone';
...
export function createDate(
  ...
  format: MomentFormatSpecification | undefined
) {
  ...
  if (fragments !== null) {
    return moment().subtract(
      ...
      fragments[2] as unitOfTime.DurationConstructor
    );
  }
...
export function cleanDatePublished(
  dateString: string,
  {
    timezone,
    format,
