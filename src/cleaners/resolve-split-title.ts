...
function extractBreadcrumbTitle(splitTitle: string[], text: string): string | undefined {
  ...
  if (splitTitle.length >= 6) {
    ...
    // the title.
    const termCounts = splitTitle.reduce(
      (acc, titleText) => {
...
function cleanDomainFromTitle(splitTitle: string[], url: string): string | undefined {
...
export function resolveSplitTitle(title: string, url = ''): string {
