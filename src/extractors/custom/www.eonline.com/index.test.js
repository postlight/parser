...
describe('WwwEonlineComExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html =
        fs.readFileSync('./fixtures/www.eonline.com/1481567592820.html');
      result =
    ...
    // the article.
      assert.equal(title, 'Ryan Gosling\'s Feelings About Fatherhood Will Make Your Heart Sing');
    });
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(lead_image_url, 'http://akns-images.eonline.com/eol_images/Entire_Site/2016117/rs_300x300-161207101544-600.ryan-gosling-gq.12716.jpg?downsize=600:*&crop=600:315;left,top');
    });
