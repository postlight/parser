...
describe('WwwTodayComExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html =
        fs.readFileSync('./fixtures/www.today.com/1482432737905.html');
      result =
    ...
    // the article.
      assert.equal(title, 'Take a tour inside Zsa Zsa Gabor\'s former Palm Springs retreat — it\'s for sale!');
    });
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(lead_image_url, 'http://media1.s-nbcnews.com/i/newscms/2016_51/1183946/zsa-zsa-pool-2-today-161222-tease_ef3cb1c171786baa69a3f5db09f3da06.jpg');
    });
