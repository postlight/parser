...
describe('WwwRecodeNetExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html =
        fs.readFileSync('./fixtures/www.recode.net/1481841159344.html');
      result =
    ...
    // the article.
      assert.equal(title, 'FCC chairman Tom Wheeler’s departure is the death knell for net neutrality');
    });
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(lead_image_url, 'https://cdn0.vox-cdn.com/thumbor/vYSadgIaWQTfllNFgfisldW3AFA=/0x30:2166x1248/1600x900/cdn0.vox-cdn.com/uploads/chorus_image/image/52310757/464506458.1481828109.jpeg');
    });
