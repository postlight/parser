...
describe('WwwVoxComExtractor', () => {
  describe('initial test case', () => {
    ...
    // the article.
      assert.equal(title, 'Donald Trump’s tweets fit a pattern of harassment Twitter has banned before');
    });
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(dek, 'The President-elect’s targets may endure real-life threats from hordes of his supporters.');
    });
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(lead_image_url, 'https://cdn0.vox-cdn.com/thumbor/RuJTDlBH9LAp_9uFqYfnPzWXhj0=/0x175:2500x1564/1080x600/cdn0.vox-cdn.com/uploads/chorus_image/image/52223131/628656068.0.jpeg');
    });
