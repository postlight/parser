...
describe('FortuneComExtractor', () => {
  describe('initial test case', () => {
    ...
    // the article.
      assert.equal(title, 'Here Are 6 Can’t-Miss Gadgets Powered by Amazon’s Alexa Assistant');
    });
    ...
    it('returns the content', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(first13, 'The Amazon Echo Dot, the retailer’s puck-shaped smart speaker, is is killing it');
    });
  });
});
