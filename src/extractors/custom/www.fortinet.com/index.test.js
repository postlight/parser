...
describe('WwwFortinetComExtractor', () => {
  describe('initial test case', () => {
    ...
    beforeAll(() => {
      ...
      const html =
        fs.readFileSync('./fixtures/www.fortinet.com/1546954846985.html');
      result =
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(lead_image_url, 'https://www.fortinet.com/content/dam/fortinet-blog/article-images/defeating_an_android_packer_with_frida/frida_02.png');
    });
    ...
    it('returns the content', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(first13, 'A FortiGuard Labs How-To Guide for Cybersecurity Threat Researchers Here at FortiGuard Labs');
    });
  });
});
