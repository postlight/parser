...
describe('WwwDmagazineComExtractor', () => {
  describe('initial test case', () => {
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(dek, 'The Supreme Court defers. Tony Dorsett and other former players can get paid.');
    });
    ...
    it('returns the content', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(first13, 'COLLISION COURSE: Dorsett, photographed in his home December 19, 2013, faces his old,');
    });
  });
});
