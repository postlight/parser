...
describe('PeopleComExtractor', () => {
  describe('initial test case', () => {
    ...
    // the article.
      assert.equal(title, 'Jennifer Aniston on Leaving the Tags on Her Celine Coat: ‘I Wore It Four Times and Didn’t Notice!’');
    });
    ...
    it('returns the content', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(first13, 'People who don’t chronicle every item of clothing worn by the rich and');
    });
  });
});
