...
describe('WwwSlateComExtractor', () => {
  describe('initial test case', () => {
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(dek, 'Trump’s promises to “take care” of inner city, rural, and Rust Belt voters have officially proved to be a con.');
    });
    ...
    // Update these values with the expected values from
    // the article.
      assert.equal(lead_image_url, 'http://www.slate.com/content/dam/slate/articles/news_and_politics/politics/2017/03/170309_POL_trumpRally.jpg.CROP.cq5dam_web_1280_1280_jpeg.jpg');
    });
    ...
    it('returns the content', async () => {
      ...
      // Update these values with the expected values from
      // the article.
      assert.equal(first13, 'Then-nominee Donald Trump speaks at a rally on Sept. 28 in Waukesha, Wisconsin.');
    });
  });
});
