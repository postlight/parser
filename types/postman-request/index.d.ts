...
declare module 'postman-request' {
  ...
  export interface DefaultUriUrlRequestApi<
    TRequest extends Request,
    TOptions extends CoreOptions,
    TUriUrlOptions
  ...
  export interface Request extends caseless.Httpified, stream.Stream {
    readable: boolean;
    writable: boolean;
  ...
  export const request: RequestAPI<Request, CoreOptions, RequiredUriUrl>;
