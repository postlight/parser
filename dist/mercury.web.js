var Mercury = (function() {
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    ...
                    break;
                  case 5:
                    return (e.next = 7), Da(t, r);
                  case 7:
                    a = e.sent;
                  case 8:
                    if (a.error) return (a.failed = !0), e.abrupt('return', a);
                    e.next = 11;
                    break;
                  case 11:
                    return e.abrupt('return', this.generateDoc(a));
                  case 12:
                  case 'end':
                    return e.stop();
                }
  ...
  var qo = {
      ...
      content: {
        ...
        transforms: {
          '.pane-node-body': function(e, t) {
            var n = ra(Go.lead_image_url.selectors[0], 2),
              r = n[0],
              a = n[1],
              i = t(r).attr(a);
    ...
    Uo = ut(Bo).reduce(function(e, t) {
      ...
      return pt(
        ...
        (n = r).supportedDomains
          ? Wo(n, [n.domain].concat(ui(n.supportedDomains)))
          : Wo(n, [n.domain])
      );
    }, {}),
    $o = e(function(e, t) {
    ...
    Vo = ($o.getDirection, $o.patch, /^\s*(posted |written )?by\s*:?\s*(.*)/i),
    Ko = new RegExp('http(s)?://', 'i'),
    Jo = /^\d{13}$/i,
    Xo = /^\d{10}$/i,
    Zo = /^\s*published\s*:?\s*(.*)/i,
    Qo = /(.*\d)(am|pm)(.*)/i,
    es = /\.m\./i,
    ts = [
      'jan',
    ...
    rs = /-\d{3,4}$/,
    as = /(: | - | \| )/g,
    is = new RegExp('.com$|.net$|.org$|.co.uk$', 'g');
  function os(e) {
    return Nr(e.replace(Vo, '$2').trim());
  }
  var ss = e(function(e) {
    !(function(e) {
      (e.exports.is_uri = f),
  ...
  function cs(e) {
    return (e = e.trim()), ss.isWebUri(e) ? e : null;
  }
  var ls = e(function(Un, e) {
      Un.exports = (function() {
        var e, a;
        function g() {
        ...
        F('H', ['HH', 2], 0, 'hour'),
          ...
          F('hmmss', 0, 0, function() {
            return (
              '' + et.apply(this) + Y(this.minutes(), 2) + Y(this.seconds(), 2)
            );
          }),
          F('Hmm', 0, 0, function() {
                ...
                e._w &&
                  ...
                  (function(e) {
                    ...
                    if (null != (t = e._w).GG || null != t.W || null != t.E)
                      (i = 1),
                        (o = 4),
                        (n = pt(t.GG, e._a[me], Ge(Dt(), 1, 4).year)),
                        (r = pt(t.W, 1)),
                        ((a = pt(t.E, 1)) < 1 || 7 < a) && (c = !0);
                    else {
                      (i = e._locale._week.dow), (o = e._locale._week.doy);
                      var l = Ge(Dt(), i, o);
                      (n = pt(t.gg, e._a[me], l.year)),
                        (r = pt(t.w, l.week)),
                        null != t.d
                          ? ((a = t.d) < 0 || 6 < a) && (c = !0)
                          : null != t.e
        ...
        function Ht(e, t) {
          ...
          return t._isUTC
            ? ((n = t.clone()),
              (r =
                (w(e) || o(e) ? e.valueOf() : Dt(e).valueOf()) - n.valueOf()),
          ...
          return (
            Lt(e)
              ...
              : 'object' == typeof c &&
                ...
                (a =
                  i.isValid() && o.isValid()
                    ? ((o = Ht(o, i)),
                      i.isBefore(o)
                        ? (s = Vt(i, o))
                        : (((s = Vt(o, i)).milliseconds = -s.milliseconds),
                          (s.months = -s.months)),
                      s)
                ...
                (c.M = a.months)),
            (r = new zt(c)),
            Lt(e) && v(e, '_locale') && (r._locale = e._locale),
            r
          );
        }
        function $t(e, t) {
          ...
          return function(e, t) {
            ...
            return (
              null === t ||
                ...
                (e = t),
                (t = n)),
              Jt(this, Ut((e = 'string' == typeof e ? +e : e), t), r),
              this
            );
          };
        }
        ...
        (hn.add = Xt),
          ...
          (hn.from = function(e, t) {
            return this.isValid() && ((w(e) && e.isValid()) || Dt(e).isValid())
              ? Ut({ to: this, from: e })
                  .locale(this.locale())
                  .humanize(!t)
          ...
          (hn.hour = hn.hours = at),
          (hn.minute = hn.minutes = sn),
          (hn.second = hn.seconds = ln),
          (hn.millisecond = hn.milliseconds = fn),
          ...
          (hn.dates = n('dates accessor is deprecated. Use date instead.', on)),
          (hn.months = n(
            'months accessor is deprecated. Use month instead',
            Re
          )),
          (hn.years = n('years accessor is deprecated. Use year instead', Ee)),
          (hn.zone = n(
        ...
        function vn(e, t, n, r) {
          ...
          var s = [];
          for (a = 0; a < 7; a++) s[a] = mn(t, (a + o) % 7, r, 'day');
          return s;
        }
        (pn.calendar = function(e, t, n) {
          ...
          (pn.weekdaysRegex = function(e) {
            return this._weekdaysParseExact
              ? (v(this, '_weekdaysRegex') || Qe.call(this),
          ...
          (pn.weekdaysMinRegex = function(e) {
            return this._weekdaysParseExact
              ...
              : (v(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = Ze),
    ...
    us = e(function(e) {
      ...
      (t = this),
        ...
        e.exports ? (e.exports = n(ls)) : n(t.moment);
    }),
    fs = function(e, t) {
      var n = e.toString();
      function r(r) {
      ...
      if (
        (((t = t || {}).preferredOrder = t.preferredOrder || Xs),
        (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = (n = n.replace(
          Ks,
          'x'
        )).replace(Js, 'X')).replace(Vs, '[$1]')).replace(hs, 'dddd')).replace(
          ds,
          'ddd'
        )).replace(ps, 'dd')).replace(vs, 'Do')).replace(ms, 'MMMM')).replace(
          gs,
          'MMM'
        )).replace(
          ys,
        ...
        )).replace(bs, 'Z')).replace(Es, 'HH:mm:ss.SSS')).replace(
          Ts,
          'HH:mm:ss.SS'
        )).replace(Cs, 'HH:mm:ss.S')).replace(ws, r('hh:mm:ss'))).replace(
          ks,
          r('h:mm:ss')
        )).replace(As, r('hh:mm'))).replace(Ms, r('h:mm'))).replace(
          xs,
          r('hh')
        )).replace(Ss, r('h'))).replace(Ds, 'HH:mm:ss')).replace(
          Ns,
          'H:mm:ss.SSS'
        )).replace(Ps, 'H:mm:ss.SS')).replace(zs, 'H:mm:ss.S')).replace(
          js,
          'H:mm:ss'
        )).replace(Os, 'HH:mm')).replace(Ls, 'H:mm')).replace(
          Rs,
          'YYYY'
        )).replace(Hs, 'D/M')).replace(Is, 'D/MM')).replace(
          Fs,
          'DD/M'
        )).replace(Gs, 'DD/MM')).replace(Bs, 'M/YY')).replace(
          Us,
          'MM/YY'
        )).match($s))
      ) {
      ...
      (n = (n = (n = n.replace(Ys, 'DD')).replace(Ws, 'D')).replace(qs, 'YY'))
        .length < 1 && (n = void 0);
      return n;
    },
    hs = new RegExp(
    ...
    vs = /(\d+)(st|nd|rd|th)\b/i,
    ys = /(\d{1,4})([/.-])(\d{1,2})[/.-](\d{1,4})/,
    bs = /((\+|-)\d\d:?\d\d)$/,
    _s = '(' + ['AM?', 'PM?'].join('|') + ')',
    ws = new RegExp('0\\d\\:\\d{1,2}\\:\\d{1,2}(\\s*)' + _s, 'i'),
    As = new RegExp('0\\d\\:\\d{1,2}(\\s*)' + _s, 'i'),
    xs = new RegExp('0\\d(\\s*)' + _s, 'i'),
    ks = new RegExp('\\d{1,2}\\:\\d{1,2}\\:\\d{1,2}(\\s*)' + _s, 'i'),
    Ms = new RegExp('\\d{1,2}\\:\\d{1,2}(\\s*)' + _s, 'i'),
    Ss = new RegExp('\\d{1,2}(\\s*)' + _s, 'i'),
    Es = /\d{2}:\d{2}:\d{2}\.\d{3}/,
    Ts = /\d{2}:\d{2}:\d{2}\.\d{2}/,
    Cs = /\d{2}:\d{2}:\d{2}\.\d{1}/,
    Ds = /0\d:\d{2}:\d{2}/,
    Os = /0\d:\d{2}/,
    js = /\d{1,2}:\d{2}:\d{2}/,
    Ns = /\d{1,2}:\d{2}:\d{2}\.\d{3}/,
    Ps = /\d{1,2}:\d{2}:\d{2}\.\d{2}/,
    zs = /\d{1,2}:\d{2}:\d{2}\.\d{1}/,
    Ls = /\d{1,2}:\d{2}/,
    Rs = /\d{4}/,
    Ys = /0\d/,
    Ws = /\d{1,2}/,
    ...
    Hs = /^([1-9])\/([1-9]|0[1-9])$/,
    Is = /^([1-9])\/(1[012])$/,
    Fs = /^(0[1-9]|[12][0-9]|3[01])\/([1-9])$/,
    Gs = /^(0[1-9]|[12][0-9]|3[01])\/(1[012]|0[1-9])$/,
    Bs = /^([1-9])\/([1-9][0-9])$/,
    Us = /^(0[1-9]|1[012])\/([1-9][0-9])$/,
    $s = /([/][M]|[M][/]|[MM]|[MMMM])/,
    Vs = /\b(at)\b/i,
    Ks = /\d{13}/,
    Js = /\d{10}/,
  ...
  function ec(e) {
    var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
      n = t.timezone,
      r = t.format;
    if (Jo.test(e) || Xo.test(e)) return new Date(Br(e, 10)).toISOString();
    var a = Qs(e, n, r);
    return (
      a.isValid() ||
        (a = Qs(
      ...
      (as.test(e) &&
        (e = (function(e) {
          ...
          return (
            r ||
            (r = (function(e, t) {
              var n = Mr.parse(t).host.replace(is, ''),
                r = e[0].toLowerCase().replace(' ', '');
              if (0.4 < oc.levenshtein(r, n) && 5 < r.length)
                return e.slice(2).join('');
              var a = e
                .slice(-1)[0]
                .toLowerCase()
                .replace(' ', '');
              return 0.4 < oc.levenshtein(a, n) && 5 <= a.length
                ? e.slice(0, -2).join('')
                : null;
            })(n, t)) ||
            e
  ...
  var oc = {
    ...
    levenshtein: function(e, t, n) {
      if (((e = ic(e)), (t = ic(t)), 0 === e.length)) return t.length;
    ...
    jaccard: function(e, t) {
      return (
        (e = ic(e)),
        (t = ic(t)),
        rc.intersection(e, t).length / rc.union(e, t).length
      );
    },
  ...
  var sc = {
    ...
    dek: function(e, t) {
      ...
      var a = To(e, n);
      return Ko.test(a) ? null : Nr(a.trim());
    },
    date_published: ec,
    content: tc,
    title: nc,
  ...
  var lc = {
    ...
    uc = ['tweetmeme-title', 'dc.title', 'rbtitle', 'headline', 'title'],
    fc = ['og:title'],
    hc = [
      '.hentry .entry-title',
      'h1#articleHeader',
    ...
    vc = /^[\n\s]*By/i,
    yc = [['#byline', vc], ['.byline', vc]],
    bc = {
      extract: function(e) {
        var t,
          n = e.$,
          r = e.metaCache;
        if ((t = Mo(n, mc, r)) && t.length < 300) return os(t);
        if ((t = Eo(n, gc, 2)) && t.length < 300) return os(t);
        var a = !0,
          i = !1,
          o = void 0;
        try {
          for (var s, c = ea(yc); !(a = (s = c.next()).done); a = !0) {
            var l = ra(s.value, 2),
              u = l[0],
              f = l[1],
              h = n(u);
    ...
    xc = {
      extract: function(e) {
        var t,
          ...
          i = e.url,
          o = e.metaCache;
        return (t = Mo(a, _c, o, !1))
          ? ec(t)
          : (t = Eo(a, wc))
          ? ec(t)
          : ((n = i),
            (t = (r = Ac.find(function(e) {
              return e.test(n);
            }))
              ? r.exec(n)[1]
              : null)
    ...
    kc = ['og:image', 'twitter:image', 'image_src'],
    Mc = ['link[rel=image_src]'],
    Sc = new RegExp(
  ...
  var Oc = {
      extract: function(e) {
        ...
        var s = za(f).reduce(
          ...
          c = ra(s, 2),
          h = c[0];
        if (0 < c[1] && (t = cs(h))) return t;
        var d = !0,
          p = !1,
          m = void 0;
        try {
          for (var g, v = ea(Mc); !(d = (g = v.next()).done); d = !0) {
            var y = g.value,
              b = l(y).first(),
              _ = b.attr('src');
            if (_ && (t = cs(_))) return t;
            var w = b.attr('href');
            if (w && (t = cs(w))) return t;
            var A = b.attr('value');
            if (A && (t = cs(A))) return t;
          }
        } catch (e) {
          (p = !0), (m = e);
        } finally {
    ...
    Nc.Differ,
    Nc.IS_LINE_JUNK,
    Nc.IS_CHARACTER_JUNK,
    Nc._formatRangeUnified,
    Nc.unifiedDiff,
    Nc._formatRangeContext,
    Nc.contextDiff,
    Nc.ndiff,
    Nc.restore,
    Nc);
  var zc = /\d/,
    ...
    Rc = new RegExp('(next|weiter|continue|>([^|]|$)|»([^|]|$))', 'i'),
    Yc = new RegExp('(first|last|end)', 'i'),
    Wc = new RegExp('(prev|earl|old|new|<|«)', 'i');
  function qc(e) {
    var t = e.links,
      k = e.articleUrl,
      M = e.baseUrl,
      ...
      r = t.reduce(function(e, t) {
        ...
        if (
          !(function(t, e, n, r, a, i) {
            ...
            var s = t.replace(n, '');
            return !(!zc.test(s) || Lc.test(a) || 25 < a.length);
          })(r, k, M, S, i, T)
        )
          return e;
        e[r]
        ...
        var o,
          ...
          x = ((s = r), C.test(s) ? 0 : -25);
        return (
          (x += ((c = w), Rc.test(c) ? 50 : 0)),
          (x += ((l = w), Yc.test(l) && Rc.test(l) ? -65 : 0)),
          (x += ((u = w), Wc.test(u) ? -200 : 0)),
          (x += ((f = a.parent()),
          (d = h = !1),
          ...
          (b = r),
          0 < (v = x)
            ? v + -250 * (1 - new Pc.SequenceMatcher(null, y, b).ratio() - 0.2)
            : 0)),
          (_.score = x),
          e
        );
  ...
  var Gc = {
    ...
    Bc = { ellipse: '…', chars: [' ', '-'], max: 140, truncate: !0 };
  var Uc = function(e, t, n) {
      if ('string' != typeof e || 0 === e.length) return '';
      if (0 === t) return '';
      for (var r in ((n = n || {}), Bc))
        (null !== n[r] && void 0 !== n[r]) || (n[r] = Bc[r]);
      return (
        (n.max = t || n.max),
        (function(e, t, n, r, a) {
    ...
    $c = ['og:description', 'twitter:description'];
  function Vc(e, t) {
    var n =
      2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 200;
    return (
      (e = e.replace(/[\s\n]+/g, ' ').trim()), Uc(e, n, { ellipse: '&hellip;' })
    );
  }
  var Kc = {
      extract: function(e) {
        var t = e.$,
          ...
          r = e.metaCache,
          a = Mo(t, $c, r);
        if (a) return Vc(To(a, t));
        return Vc(t(n.slice(0, 1e3)).text(), t, 200);
      },
    },
    Jc = {
      extract: function(e) {
    ...
    Xc = {
      domain: '*',
      title: pc.extract,
      date_published: xc.extract,
      author: bc.extract,
      content: lc.extract.bind(lc),
      lead_image_url: Oc.extract,
      dek: function() {
        return null;
      },
      next_page_url: Hc.extract,
      url_and_domain: Gc.extract,
      excerpt: Kc.extract,
      word_count: Jc.extract,
      direction: function(e) {
        var t = e.title;
        return $o.getDirection(t);
      },
      extract: function(e) {
        var t = e.html,
          n = e.$;
    ...
    Zc = {
      'meta[name="al:ios:app_name"][value="Medium"]': Fo,
      'meta[name="generator"][value="blogger"]': qo,
    };
  function Qc(e, t, n) {
    var r,
      a,
  ...
  function nl(e) {
    ...
    if (i) {
      ...
      return (
        c.wrap(t('<div></div>')),
        (c = el((c = tl((c = c.parent()), t, r)), t, r)),
        (c = sc[n](c, pt({}, e, { defaultCleaner: h }))),
        t.html(c)
      );
    }
    if (Zr(d)) {
      ...
      var y = t(d);
      l = (y = tl((y = el(y, t, r)), t, r)).text().trim();
    }
    return h ? sc[n](l, pt({}, e, r)) : l;
  }
  function rl(e) {
    var t = e.type,
      n = e.extractor,
      r = e.fallback,
      a = void 0 === r || r,
      i = nl(pt({}, e, { extractionOpts: n[t] }));
    return i || (a ? Xc[t](e) : null);
  }
  var al,
    il = {
      extract: function() {
        var e =
            0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : Xc,
        ...
        var i = rl(pt({}, t, { type: 'title' })),
          o = rl(pt({}, t, { type: 'date_published' })),
          s = rl(pt({}, t, { type: 'author' })),
          c = rl(pt({}, t, { type: 'next_page_url' })),
          l = rl(pt({}, t, { type: 'content', extractHtml: !0, title: i })),
          u = rl(pt({}, t, { type: 'lead_image_url', content: l })),
          f = rl(pt({}, t, { type: 'excerpt', content: l })),
          h = rl(pt({}, t, { type: 'dek', content: l, excerpt: f })),
          d = rl(pt({}, t, { type: 'word_count', content: l })),
          p = rl(pt({}, t, { type: 'direction', title: i })),
          m = rl(pt({}, t, { type: 'url_and_domain' })) || {
            url: null,
            domain: null,
          };
        return {
              ...
              switch ((e.prev = e.next)) {
                case 0:
                  (n = t.next_page_url),
                    ...
                    (f = [Xr(l)]);
                case 3:
                  if (n && u < 26) return (u += 1), (e.next = 7), Yo.create(n);
                  e.next = 16;
                  break;
                case 7:
                  (a = e.sent),
              ...
              switch ((e.prev = e.next)) {
                case 0:
                  if (
                    ...
                    !t &&
                      Er.browser &&
                      ((t = window.location.href), (n = n || Er.html())),
                    (c = Mr.parse(t)),
                    c.hostname)
                  ) {
                    e.next = 6;
                ...
                case 6:
                  return (e.next = 8), Yo.create(t, n, c);
                case 8:
                  if (((l = e.sent), (u = Qc(t, c, l)), l.failed))
                ...
                case 19:
                  ...
                  break;
                case 22:
                  h = pt({}, h, { total_pages: 1, rendered_pages: 1 });
                case 23:
